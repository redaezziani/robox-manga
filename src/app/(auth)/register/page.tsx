  ...
  const onSubmit = async (values: RegisterFormValues) => {
    try {
      ...
      const response = await axios.post<RegisterResponse>(
        'http://192.168.31.181:8000/api/v1/auth/register',
        registrationData,
        {
          headers: {
        ...
        <Form {...form}>
          ...
          >
            <div className="space-y-2">
              <h2 className="text-3xl font-semibold ">إنشاء حساب جديد</h2>
              <p className="text-gray-500">مرحبًا بك! يرجى إدخال بياناتك لإنشاء حساب جديد.</p>
            </div>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="space-y-2">
                  <FormLabel className="text-sm font-medium">الاسم</FormLabel>
                  <FormControl>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="space-y-2">
                  <FormLabel className="text-sm font-medium">تأكيد كلمة المرور</FormLabel>
                  <FormControl>
                    <PasswordInput {...field} />
                  </FormControl>
                  <FormMessage />
