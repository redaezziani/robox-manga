...
import DetailsPath from "./details-path";
...
export default function MangaDetails({ slug }: MangaDetailsProps) {
    const { manga, similarManga, isLoading, error } = useMangaDetailsSWR(slug);
    ...
    return (
        <div className="space-y-10">
            ...
            {/* Add Similar Manga Section */}
            {similarManga && similarManga.length > 0 && (
                <MangaList
                    title="مانجا مشابهة"
                    mangas={similarManga}
                    isLoading={false}
