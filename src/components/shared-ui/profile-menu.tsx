        ...
        <DropdownMenu >
            <DropdownMenuTrigger asChild>
                <Button variant="ghost" className="h-auto p-0 hover:bg-transparent">
                    <Avatar>
                        <AvatarImage
                            src={user?.profile || "https://i.pinimg.com/236x/74/f1/ce/74f1ce7c4ad30541384ffb6415ea2745.jpg"}
            ...
            <DropdownMenuContent lang='ar' className="!w-44">
                ...
                <DropdownMenuSeparator />
                <DropdownMenuGroup
                className=' !w-full !flex  justify-start items-end flex-col gap-2 '
                >
                ...
                <DropdownMenuSeparator />
                <DropdownMenuGroup className='!w-full !flex  justify-start items-end flex-col gap-2'>
                    <DropdownMenuItem>
                    <span>الخيار 4</span>
